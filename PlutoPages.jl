...
function process_layouts(page::Page)::Page
	...
	if haskey(output.frontmatter, "layout")
		...
		missing_navigation_paths = join(getproperty.(missing_navigation_pages, :path), ", ")
		isempty(missing_navigation_pages) || error("YAML navigation entries were not generated: $missing_navigation_paths")
