...
md"""
Source imaging in homogeneous media. We have recorded seismograms at a bunch of receivers. And now we would like to backpropagate these seismograms to the source location to form an image. Applications include earthquake source characterization, 
...
begin
	# adjust medium parameters here
	v0 = 2500. # background velocity in m/s
	rho0 = 2000. # background density in kg/m3
	
	xgrid = range(-1000, stop=1000, step=10)
	zgrid = range(0, stop=2000, step=10)
	...
	freqs = [10., 12., 15., 20.,]
	# freqs = range(1, stop=10, length=20)
	# freqs = rfftfreq(length(tgrid), inv(step(tgrid)))
	fpeak = 2.
...
# ╔═╡ a386bfc1-d20c-40a0-a3ce-e03da2f2df1e
...
# ╔═╡ f68dafdf-aaa9-4aad-94d9-e5769d99c0ca
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "b1d65411e2c695967665404730bf0a7b14e26a5e"
