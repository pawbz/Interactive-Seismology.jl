...
md"""
# Oscillations
This notebook creates an interactive environment to explore the oscillations of `N` particles attached to springs.
...
md"Select the model to visualize: $(@bind imode Slider(1:length(roots), show_value=true))"
...
manifest_format = "2.0"
project_hash = "26fb13c633a07bc1f3e919589fde3057fe0d5b26"
