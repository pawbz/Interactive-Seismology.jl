...
@bind _source_params PlutoUI.combine() do Child
    md"""
    ## Source Distribution
    | Parameter | Value | Notes |
    |:---|:---|:---|
    | Number of sources | $(Child("number_of_sources", Slider(1000:1000:10000, default=1000, show_value=true))) | total noise sources |
    | Inner radius | $(Child("inrad", Slider(1:2:17, default=1, show_value=true))) | minimum source distance |
    | Angular range | $(Child("iang", Select(["all" => "Circular", "small" => "Sectional", "leftarc" => "Right Arc", "rightarc" => "Left Arc", "new" => "Special case", "bimodal" => "Random Bimodal"]))) | source geometry |
...
begin
    ...
    number_of_sources = _source_params.number_of_sources
    inrad           = _source_params.inrad
    iang            = _source_params.iang
    source_distance = _source_params.source_distance
...
manifest_format = "2.0"
project_hash = "192aa3ca470f45f335994e5c169f4c148640e36a"
