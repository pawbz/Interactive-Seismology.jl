...
# ╔═╡ 9533212c-b55e-4f07-86a3-4237d1b528e7
begin
	ENV["JULIA_COPY_STACKS"] = "1"
	using PlutoPlotly, TauP
end

# ╔═╡ 142ac190-e5e4-11ee-30bd-532826b5ecae
x= range(-1, 1, length=100)

# ╔═╡ 98dcb1b2-aba4-4ca5-bf7f-4ac125638f3a


# ╔═╡ 5c70552d-75b5-4553-8adc-f97c1e9cba92
TimeTauP = taup_time(["P","S"], 55.0, 100.0; model = "iasp91", verbose = true)

# ╔═╡ 00000000-0000-0000-0000-000000000001
PLUTO_PROJECT_TOML_CONTENTS = """
[deps]
PlutoPlotly = "8e989ff0-3d88-8e9f-f020-2b208a939ff0"
TauP = "dd4fbf09-c66a-460f-850c-a6bf3253bb5f"
...
manifest_format = "2.0"
project_hash = "147f5de20ef4f9d480c719e22dcd04b78305ac16"
...
[[deps.TauP]]
deps = ["CatViews", "DataStructures", "Interpolations", "JavaCall"]
